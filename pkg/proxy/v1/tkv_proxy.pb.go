...
func (x *CommitRequest) GetShouldRetry() bool {
	if x != nil {
...
const file_tkv_proxy_proto_rawDesc = "" +
	...
	"\bstart_ts\x18\x01 \x01(\x04R\astartTs\x12\x12\n" +
	"\x04keys\x18\x02 \x03(\fR\x04keys\x12\x16\n" +
	"\x06values\x18\x03 \x03(\fR\x06values\"y\n" +
	"\rCommitRequest\x12\x19\n" +
	"\bstart_ts\x18\x01 \x01(\x04R\astartTs\x12\x12\n" +
	"\x04keys\x18\x03 \x03(\fR\x04keys\x12\x16\n" +
	"\x06values\x18\x04 \x03(\fR\x06values\x12!\n" +
	"\fshould_retry\x18\x05 \x01(\bR\vshouldRetry\"-\n" +
